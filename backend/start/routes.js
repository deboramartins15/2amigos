...
Route.resource("motoristas", "MotoristaController").apiOnly().middleware("auth");
...
Route.post("/romaneio/export/csv","RomaneioController.exportToCSV").middleware("auth")
...
Route.get("/download/:type","DownloadController.download")
